...
class MenuScene: SKScene, GameViewControllerDelegate {
    ...
    enum Button: Int {
        case FIRST_VIDEO, SECOND_VIDEO, THIRD_VIDEO, FOURTH_VIDEO, FIFTH_VIDEO, SIXTH_VIDEO, PURCHASE_ALL, RESTORE
    ...
    var isUnlockedSixthVideo = false
    ...
    func buttonPressed(sender: UITapGestureRecognizer) {
        ...
        } else if focusedButton == .SIXTH_VIDEO {
